...
module.exports = {
  menu: [
    ...
    { label: 'VERSION', enabled: false, visible: false },
    {
    ...
    { type: 'separator' },
    { label: localized('By:  Ni But Crazy'), enabled: false },
    { label: localized('Print Current Thread'), command: 'core:print-thread', visible: false },
    { type: 'separator' },
